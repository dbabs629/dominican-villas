      ...
      <main className="mx-auto w-full xl:w-11/12">
        ...
        <section className="mx-auto my-10 w-11/12 text-sm sm:w-2/3 sm:text-base">
          <article className="my-10 space-y-10">
            ...
            <p>
              This villa will sleep up to 10 people with 2 bedrooms having
              king-size beds, the third bedroom has 2 queen-size beds and 2
              single-size beds with a play pen for a baby to play or sleep in.
              ...
              dishes, cups, silverware, and a booster seat for baby. It has a
              dining room table, full living room with a smart TV, there are
              child and adults board games along with infant toys and infant
              walker. Outdoor furniture, BBQ, private chlorine pool, outdoor
              washroom, outdoor laundry room with washer and dryer (detergent
              and dryer sheets included), lounge chairs by the pool, life
              jackets for infants and young kids, pool floats and toys and a
              backup generator so you will never run out of power.
            </p>
          </article>
          <article className="my-10 space-y-10">
