...
export default function Gallery({
  ...
  return (
    <div className="mx-auto grid w-full max-w-full grid-cols-4 md:grid-cols-6 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-8">
      {imgListLength.map((imgNum) =>
        currentImgNum === imgNum ? (
          <div
            key={imgNum * 1000}
            className="relative box-border h-16 max-w-full border xxs:h-20 s:h-28 md:h-28 lg:h-36 2xl:h-44"
          >
            {!loaded && (
              <span
                key={imgNum * 2000}
            ...
            <Image
              ...
              fill={true}
              sizes="(max-width: 640px) 25vw, (max-width: 768px) 16.66vw, (max-width: 1024px) 12.5vw, 8vw"
