...
export default function HeroSection() {
  return (
    <section className="mx-auto mt-20 flex h-auto w-full max-w-[1200px] flex-col items-center justify-center bg-blue-400 pb-8 sm:w-11/12 sm:rounded-xl sm:p-8 lg:w-11/12 lg:flex-row lg:items-start lg:p-16 2xl:w-2/3">
      ...
      <div className="flex w-4/5 flex-col space-y-10 text-white md:w-full lg:w-2/3">
        ...
        <p className="text-sm md:text-base lg:text-lg">
          ...
          away from the pristine ocean, thrilling waterparks, stunning beaches
          and grocery stores!
        </p>
        <p className="text-sm md:text-base lg:text-lg">
          Escape to paradise in the ocean view villa (sleeps 6) or the bungalow
          villa (sleeps 10). Unwind in the cozy living room, enjoy culinary
          luxury in the fully equipped kitchen and step into an amazing outdoor
          oasis. The private swimming pool becomes your personal heaven,
          inviting you to bask in the sun and create unforgettable moments.
          Whether it's family or a romantic escape, the villas promise comfort
          and luxury for your ultimate vacation experience!
        </p>
      </div>
    </section>
  );
