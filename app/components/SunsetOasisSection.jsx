...
export default function SunsetOasisSection() {
  return (
    <section className="relative mt-40 flex w-full flex-col sm:my-80">
      ...
      <div className="absolute bottom-0 flex w-full flex-col space-y-4 bg-blue-400 p-6 text-white xs:-bottom-10 sm:-bottom-48 sm:right-20 sm:w-2/3 sm:rounded-lg sm:p-8 sm:text-lg md:w-[500px]">
