        ...
        <section className="mx-auto my-10 w-full max-w-[800px] text-sm sm:w-11/12 sm:text-base lg:w-2/3">
          <article className="mx-auto my-20 w-full space-y-10 pb-40 text-blue-900 sm:rounded-xl sm:border sm:p-20 sm:shadow-lg">
            ...
            <p className="mx-auto w-11/12 text-sm sm:w-full md:text-base">
              ...
              bedrooms have 1 queen-size bed. One is located on the main floor
              and one on the 2nd floor with a balcony. All bedrooms have their
              own air conditioner, ceiling fan and their own full bathroom with
              a hair dryer. All bedrooms are equipped with bed sheets, pillows,
          ...
          <article className="mx-auto my-10 flex w-full flex-col items-center justify-center space-y-10 bg-blue-400 py-10 text-white sm:rounded-xl sm:shadow-lg">
          ...
          <article className="my-10 w-full space-y-10 pb-40 text-blue-900 sm:rounded-xl sm:border sm:shadow-lg md:p-20">
            ...
            <ul className="mx-auto flex h-auto flex-col items-center space-y-8">
              <p>
                1 week stay (7 night stay)......... $225.00 Per/ Night $1,575.00
              </p>
              <p>
                2 week stay (14 night stay)......... $200.00 Per/ Night
                $2,800.00
              </p>
              <p>
                3 week stay (21 night stay)......... $175.00 Per/ Night
                $3,675.00
              </p>
              <p>
          ...
          <article className="my-10 space-y-10 pb-40 text-blue-900 sm:rounded-xl sm:border sm:p-20 sm:shadow-lg">
            ...
            <p className="mx-auto w-11/12 sm:w-full">
              ...
              back to Sunset Oasis Villa for a cocktail or two and relax by the
              private pool and unwind. See Mama's Paradise if you require
